...
function printConfiguration() {
  ...
  echo -e "    it create following structure"
  echo -e "      - create build directory"
  echo -e "      - initialize empty Dockerfile if build directory path"
  echo -e "      - copy template edjanger.template and configuration.properties in your docker working directory"
  echo -e "      - create edjanger.${config_extension} from template file (edjanger.template) and properties file (configuration.properties)"
